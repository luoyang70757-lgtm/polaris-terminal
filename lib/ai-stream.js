...
async function callAiStream(base, mdl, format, apiKey, messages, onEvent) {
  let headers, body;
  if (format === 'openai') {
    ...
    body = {
      ...
      tools: [AI_TOOL_OPENAI, AI_TOOL_CLEAR_OPENAI],
    };
  } else {
    headers = { 'Content-Type': 'application/json', 'x-api-key': apiKey, 'anthropic-version': '2023-06-01' };
    body = { model: mdl, max_tokens: 2048, stream: true, system: AI_SYSTEM_PROMPT, messages, tools: [AI_TOOL_ANTHROPIC, AI_TOOL_CLEAR_ANTHROPIC] };
  }
...
module.exports = { callAiStream, normalizeAiUrl, AI_SYSTEM_PROMPT };
