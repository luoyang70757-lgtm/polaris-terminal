...
**当前版本 v1.0.44**（2026-09-15 发版；v1.0.44 修 SFTP 下载失败不可见 + 写句柄泄漏）：含敏感输入不落盘、取消传输保留半成品、批量传输并入加固管线、危险命令确认覆盖全部一键入口、批量连接不抢焦点、多堡垒机资产分键、xlsx 换官方 tarball 等；问题清单见 `docs/issues-2026-09-11.md`。
